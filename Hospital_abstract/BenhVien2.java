        ...
        do {
            ...
            switch (choice) {
                ...
                case 11:
                    ...
                    // Nhập ngày giờ theo định dạng dd/MM/yyyy
                    while (appointmentDateTime == null) {
                        try {
                            System.out.print("Nhap ngay gio lich hen (dd/MM/yyyy HH:mm): ");
                            String dateString = sc.nextLine();
                            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
                            appointmentDateTime = LocalDateTime.parse(dateString, formatter);
                        } catch (DateTimeParseException e) {
                            System.out.println("Dinh dang ngay gio khong hop le! Vui long nhap lai.");
                        }
                    }
                    ...
                    Patient patientForAppointment = patientList.findPatient(patientIdForAppointment);
                    if (patientForAppointment != null) {
                        patientForAppointment.addAppointment(newAppointment);
                    }
